...
function randomWin () {
    ...
    if( chance < document.getElementById('numBalls').innerHTML ) {
        document.getElementById('win').innerHTML = "You Won. You will receive the base payment plus the winning amount as a bonus. In order to get paid, you must remember that there were a total of " + numBalls + " winning balls. We will ask you to recall this number later. If you do not recall it correctly, your data will be deemed invalid. Please add" + numBalls + "at the end of your study code.";
    } else {
        document.getElementById('win').innerHTML = "Sorry. You Didn't Win. But you will still receive the base payment. In order to get paid, you must remember that there were a total of " + numBalls + " winning balls. We will ask you to recall this number later. If you do not recall it correctly, your data will be deemed invalid.";
    }
} //
